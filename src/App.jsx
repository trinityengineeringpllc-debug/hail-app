...
YOUR ONLY TASKS:
1. Write a 2-3 sentence forensic weather summary. If DATE OF LOSS is provided, the summary MUST reference wind and precipitation conditions from ASOS stations only. Do NOT assess hail probability from ASOS data — ASOS does not detect hail. If NEXRAD data is provided and matches the date of loss, reference it explicitly by radar site, detection magnitude, and distance from the subject property (e.g. "WSR-88D radar site KOHX detected 3.75 inch hail aloft approximately 12 miles from the subject property on the date of loss per FMH-11 Part C"). Do NOT say hail fell AT the property — say it was detected NEAR or WITHIN X miles of the property. If the nearest NEXRAD detection is more than 10 miles away, explicitly note the distance and state that conditions at the subject property may have differed. If no NEXRAD data is provided for the date of loss, do not mention hail probability at all.
